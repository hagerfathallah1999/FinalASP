...
{
    public class PhysicalOrderController : Controller
    {
        ...
        public PhysicalOrderController(IDeliveryCompanyRepository _DeliveryCompanyRepo, IKitchenRepository _IKitchenRepo,
        ...
        {
            List<PhysicalOrder> PhysicalOrderModel = IPhysicalOrderRepo.GetAll();
            return View("Index", PhysicalOrderModel);
        }
    }
}
