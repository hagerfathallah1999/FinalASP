...
namespace FinalASP.Controllers
{
    public class VirtualOrderController : Controller
    {
        ...
        public VirtualOrderController(IDeliveryCompanyRepository _DeliveryCompanyRepo, IKitchenRepository _IKitchenRepo,
        ...
        {
            List<VirtualOrder> VirtualOrderModel = IVirtualOrderRepo.GetAll();
            return View("Index", VirtualOrderModel);
        }
    }
}
